														...
														<div class="row">
																...
																<div class="form-group form-group-default">
																	...
																	<select class="form-control" name="AccountId" required="">
																		...
																		foreach ($data_nasabah->result_array() as $row) :
																			...
																			<option value="<?php echo $AccountId?>"><?php echo $Name;?></option>
																		<?php endforeach;?>
																	</select>
																</div>
															</div>
															<div class="col-sm-6">
																<div class="form-group form-group-default">
																	...
																	<input name="TransactionDate" type="date" class="form-control" placeholder="">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-4">
																<div class="form-group form-group-default">
																	...
																	<select name="DebitCreditStatus" class="form-control" required="">
																		<option value=""> Pilih </option>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												<?php
												$no = 0;
												foreach ($data_transaksi->result_array() as $row) :

													$no++;
													$AccountId           = $row['AccountId'];
													$TransactionDate 				 = $row['TransactionDate'];
													$Description  = $row['Description'];
													$DebitCreditStatus = $row['DebitCreditStatus'];
													$Amount    = $row['Amount'];
													?>
													<tr>
														<td><?php echo $no ?></td>
														...
														<td><?php echo $DebitCreditStatus;?></td>
